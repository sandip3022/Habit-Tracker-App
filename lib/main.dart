...
import 'package:habit_tracker_app_2026/features/habit_tracker/presentation/state_management/security_lifecycle_wrapper.dart';
...
void main() async {
  ...
  runApp(
    ProviderScope(
      ...
      overrides: [habitBoxProvider.overrideWithValue(box)],
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      home: const SecurityLifecycleWrapper(child: SplashScreen()),
    );
  }
}
